...
public class QuestionScreen2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        questionField.setText("(February) You keep hearing about this coronavirus in other countries, but don’t think much of it. How will you react?");
        ...
        aButton.setText("A. Buy a plane ticket to another country because they’re just so cheap right now!");
        ...
        bButton.setText("B. Stock up on essentials, but don’t go too wild so as not contribute to any potential shortages ");
        ...
        cButton.setText("C. Do nothing. Stay up to date on the news surrounding the virus but otherwise remain calm");
    ...
    private void cButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cButtonActionPerformed
        PlayerScore runningScore = new PlayerScore();
       runningScore.setScore(runningScore.getScore()+ 0);
       new QuestionScreen3().setVisible(true);
        setVisible(false);
