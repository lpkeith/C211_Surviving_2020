 ...
 * @author Lance
 */
public class QuestionScreen8 extends javax.swing.JFrame {

    /**
     * Creates new form QuestionScreen
     */
    public QuestionScreen8() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        questionField.setText("(August) Normal day, students start school, businesses their first round of meetings, and BOOM: Zoom, crashes and brings the virtual world to a stop. You react by?");
        ...
        aButton.setText("A. Taking the day off from school/work, you don’t need this kind of stress in your life.");
        ...
        bButton.setText("B. Throwing your computer out an open window, who needs income/education anyways?");
        ...
        cButton.setText("C. Wait patiently for things to get back to normal with little to no tweeting about it");
        ...
        colorPanelLayout.setHorizontalGroup(
            ...
            .addGroup(colorPanelLayout.createSequentialGroup()
                .addComponent(questionField, javax.swing.GroupLayout.PREFERRED_SIZE, 1104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cButtonActionPerformed
        PlayerScore runningScore = new PlayerScore();
       runningScore.setScore(runningScore.getScore()+ 2);
       new QuestionScreen9().setVisible(true);
        setVisible(false);
    ...
    public static void showQuestionScreen() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestionScreen8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestionScreen8().setVisible(true);
            }
        });
    }
